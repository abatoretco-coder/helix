...
CURATED_SOURCES: list[dict[str, Any]] = [
    ...
    google_news("Google News - Fret Ferroviaire France", "transport ferroviaire fret France", "supply_chain", priority=3, refresh_minutes=120),
    ...
    google_news("Google News - Agritech France", "agriculture technologie France agritech", "science", priority=3, refresh_minutes=120),
    ...
    google_news("Google News - Immobilier Taux France", "immobilier France taux credit", "finance", priority=3, refresh_minutes=120),
    google_news("Google News - Crypto MiCA Europe", "regulation crypto Europe MiCA", "finance", priority=2),
    google_news("Google News - Education Numerique France", "education numerique France IA", "regulation", priority=3, refresh_minutes=120),
    google_news("Google News - Secteur Public IA France", "service public IA France administration", "regulation", priority=3, refresh_minutes=120),
    google_news("Google News - Medias IA France", "medias IA France droit auteur", "regulation", priority=3, refresh_minutes=120),
    google_news("Google News - Emploi IA France", "emploi IA France automatisation", "finance", priority=3, refresh_minutes=120),
    # Near-real-time French radars for broad breaking coverage and high-impact sectors.
    google_news("Google News - Alerte Info France", "alerte info France", "general", priority=1, refresh_minutes=15),
    google_news("Google News - Derniere Heure France", "derniere heure France actualite", "general", priority=1, refresh_minutes=15),
    google_news("Google News - Breaking France Monde", "breaking news France monde", "geopolitics", priority=1, refresh_minutes=15),
    google_news("Google News - Gouvernement France Annonce", "gouvernement France annonce", "regulation", priority=1, refresh_minutes=30),
    google_news("Google News - Assemblee Nationale Loi", "Assemblee nationale loi France", "regulation", priority=2, refresh_minutes=45),
    google_news("Google News - Crise Energie France", "crise energie France prix electricite gaz", "climate", priority=1, refresh_minutes=30),
    google_news("Google News - Industrie France Usine", "industrie France usine emploi investissement", "finance", priority=2, refresh_minutes=45),
    google_news("Google News - Rappel Produit France", "rappel produit France consommation", "general", priority=2, refresh_minutes=45),
    google_news("Google News - Greve Transport France", "greve transport France SNCF RATP aeroport", "supply_chain", priority=1, refresh_minutes=30),
    google_news("Google News - Port Maritime France", "port maritime France fret blocage", "supply_chain", priority=2, refresh_minutes=45),
    google_news("Google News - Startup IA Europe", "startup IA Europe levee fonds", "startups", priority=2, refresh_minutes=45),
    google_news("Google News - Acquisition Tech France", "acquisition tech France startup entreprise", "startups", priority=2, refresh_minutes=45),
    google_news("Google News - Fuite Donnees France", "fuite de donnees France cybersecurite", "cybersecurity", priority=1, refresh_minutes=15),
    google_news("Google News - Ransomware France", "ransomware France hopital entreprise collectivite", "cybersecurity", priority=1, refresh_minutes=15),
    google_news("Google News - Zero Day Exploite", "zero day exploite activement", "cybersecurity", priority=1, refresh_minutes=15),
    google_news("Google News - AI Agents Enterprise", "AI agents enterprise automation", "ai", "en", "US", 1, 30),
    google_news("Google News - OpenAI API", "OpenAI API release pricing", "ai", "en", "US", 1, 30),
    google_news("Google News - Anthropic Claude", "Anthropic Claude model release", "ai", "en", "US", 1, 30),
    google_news("Google News - Google Gemini", "Google Gemini model release", "ai", "en", "US", 1, 30),
    google_news("Google News - Nvidia AI Chips", "Nvidia AI chips supply", "tech", "en", "US", 1, 30),
